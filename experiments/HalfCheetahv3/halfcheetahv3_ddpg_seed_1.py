...
from AutoRL.block import ModelGenerationMushroomOnlineDDPG
...
from AutoRL.environment import BaseHalfCheetah
...
pbt_dict = dict(block_to_opt=my_ddpg, n_agents=20, n_generations=100, n_jobs=1, job_type='thread', seeder=current_seed,
