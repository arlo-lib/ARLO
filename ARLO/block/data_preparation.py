"""
This module contains the implementation of the Class DataPreparation, DataPreparationIdentity, DataPreparation1NNImputation and 
DataPreparationMeanImputation. 

The Class DataPreparation inherits from the Class Block, while the Class DataPreparationIdentity inherits from the Class 
DataPreparation.
...
class DataPreparationIdentity(DataPreparation):
    ...
    def __init__(self, eval_metric, obj_name, seeder=2, log_mode='console', checkpoint_log_path=None, verbosity=3, n_jobs=1, 
        ...
        #this block has no parameters, moreover there are also no data preparation automatic blocks and so I will never tune this
        #block        
...
class DataPreparation1NNImputation(DataPreparation):
    """
    This class implements a specific data preparation algorithm: it is an ............
    """
    ...
    def _impute_data(self, train_data):
        ...
        ######################################            ......................
        #add check: impute data only if there is missing data? or do i assume the user call the method only when 
        #there is missing data?
        
    
        knn_imputer = KNNImputer(n_neighbours=1)
        ...
        imputed_dataset = train_data.arrays_as_data(imputed_res[:,:size_obs_space], 
                                                    ...
                                                    imputed_res[:,size_obs_space+size_act_space+1:2*size_obs_space+size_act_space+1],
                                                    formatted_data[:,4],
                                                    formatted_data[:,5]
                                                    )
